                        ...
                        </div>
                        {
                            tasks.map((field, index) => (
                                <div className='mb-6' key={field.id}>
                                    ...
                                    {/* <input
                                        {...register(`tasks.${index}.description`)}
                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" key={field.id} id={field.id} type="text" placeholder="Descrição"
                                    /> */}
                                </div>
                            ))
                        }
